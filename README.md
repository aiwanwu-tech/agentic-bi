...
---
## 为什么做 Agentic BI？
很多智能问数产品的起点是 Text2SQL：
```text
自然语言问题 → SQL → 查询结果
```
这个方向有价值，但在真实业务场景中远远不够。
企业用户真正关心的往往不是数据库字段，而是业务概念：
* GMV
* 收入
* 活跃用户
* 新增客户
...
* 经营原因
* 行动建议
这些概念通常并不直接存在于数据库字段中，而是分散在指标口径、业务规则、Excel 报表、BI 看板、数据字典、业务系统和团队经验里。
所以，Agentic BI 关注的不只是“把问题转成 SQL”，而是完整的数据分析链路：
```text
业务问题
→ 语义理解
→ 本体映射
