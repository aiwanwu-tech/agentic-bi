...
![Ontology](assets/screenshots/agentic-bi-ontology.png)

### 语义层

Agentic BI 使用语义层将业务概念映射到真实数据结构。
语义层的目标是让 AI 理解业务语言，而不是只理解数据库字段。
![Semantic](assets/screenshots/agentic-bi-semantic.png)
...
![Agentic](assets/screenshots/agentic-bi-agentic.png)

### 数据层

![governance](assets/screenshots/agentic-bi-governance.png)
